...
contract DefiBridgeProxy {
    ...
    {
        console.log("DefiBridgeProxy start");
        ...
        if (isAsync) {
            ...
            console.log("DefiBridgeProxy recover output a");
            recoverTokens(
                outputAssetA,
                outputValueA,
                interactionNonce,
            ...
            console.log("DefiBridgeProxy recover output b");
            recoverTokens(
                outputAssetB,
                outputValueB,
                interactionNonce,
        ...
        console.log("DefiBridgeProxy convert call fully executed");
    }
}
