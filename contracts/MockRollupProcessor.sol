...
contract MockRollupProcessor {
        ...
        )
    {
        ...
        // TODO: For some reason, the delegatecall will we are using the if's seen below.
        // this is even if the entire delegate call is executed. Not clear what happens 
        console.log("Pain", success);
        // TODO: Makes no sense but adding the below makes success == true
        //require(success, string(result));

        // TODO: Very odd, having the success if here makes success == false.
        if (success) {
