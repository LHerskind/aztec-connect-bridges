...
contract AaveLendingBridge is IDefiBridge {
    ...
    {
        console.log("AaveLending convert 1");
        ...
        console.log("AaveLending convert, completed");
    }
